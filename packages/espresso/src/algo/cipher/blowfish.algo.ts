...
function BlowFish_Decrypt(ctx: Context, left: number, right: number) {
  let Xl = left;
  let Xr = right;
  let temp;
 ...
 */
function BlowFishInit(ctx: Context, key: number[], keysize: number) {
...
function BlowFish_Encrypt(ctx: Context, left: number, right: number) {
  let Xl = left;
  let Xr = right;
  let temp;
